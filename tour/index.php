    ...
    <div class="trainding_card_container flex">
        <!-- <div class="trending_card">
                <div class="trending_img">
                    <img src="./img/ladakh.jpg" alt="" srcset="">
                </div>
                ...
                <div class="trending_dis flex">
                    <div class="trending_inner_dis">
                        <p class="trending_price_container">Starting with: ₹<span class="trending_price">6000</span> </p>
                        <p class="treding_duration_container flex"><i class="fa-regular fa-clock"></i> <span class="trending_duration">6D/5N</span></p>
                    </div>
                    <div class="trending_inner_dis">
                        <button class="trending_btn btn">Send Enquiry</button>
                    </div>
                </div>
            </div>-->
    </div>
...
<!-- !CHOOSE US Hiking & Tracks SECTION -->
<section class="section" id="why_choose_us">
    <div class="section_header">
        <h3>Our Hiking & Trekking</h3>
    </div>
    <div class="why_choose_us_container why_choose_us_tour_container  flex">
        <p>Visit our Hiking and Trekking packages</p>
        <a href="../track/" class="btn hiking_btn">Explore More</a>
    </div>
</section>
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <p class="client_review">
                    In the past, I have travelled with numerous companies, but this one was an amazing experience.
                    The staff was incredibly accommodating and went above and beyond to ensure that I had a great
                    time.
                </p>
...
<footer id="footer" class="section flex">
    ...
    <div class="footer_div">
        ...
        <a href="https://www.linkedin.com/in/varun-salat-709a0a19a/" target="_blank" class="copyright">Designed
            Created by <span class="underline">Varun Salat <i class="fa-brands fa-linkedin-in"></i></span></a>
    </div>
</footer>
<!-- !SWIPER JS -->
